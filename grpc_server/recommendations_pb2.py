...
_RECOMMENDATIONRESPOSE = _descriptor.Descriptor(
  name='RecommendationRespose',
  full_name='RecommendationRespose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='recommendations', full_name='RecommendationRespose.recommendations', index=0,
...
_RECOMMENDATIONRESPOSE.fields_by_name['recommendations'].message_type = _BOOKRECOMMENDATION
...
DESCRIPTOR.message_types_by_name['RecommendationRespose'] = _RECOMMENDATIONRESPOSE
...
RecommendationRespose = _reflection.GeneratedProtocolMessageType('RecommendationRespose', (_message.Message,), {
  'DESCRIPTOR' : _RECOMMENDATIONRESPOSE,
  '__module__' : 'recommendations_pb2'
  # @@protoc_insertion_point(class_scope:RecommendationRespose)
  })
_sym_db.RegisterMessage(RecommendationRespose)
...
_RECOMMENDATIONS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_RECOMMENDATIONRESPOSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
