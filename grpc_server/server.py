...
from recommendations_pb2 import (
    BookCategory, BookRecommendation, RecommendationRespose
)
...
class RecommendationService(recommendations_pb2_grpc.RecommendationsServicer):
    ...
    def Recommend(self, request, context):
        ...
        books_to_recomend = random.sample(books_for_category, num_results)

        return RecommendationRespose(recommendations=books_to_recomend)
