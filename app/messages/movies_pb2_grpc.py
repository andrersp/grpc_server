...
import messages.movies_pb2 as movies__pb2


class UpdateMoviesStub(object):
...
class UpdateMoviesServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_UpdateMoviesServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        'UpdateMovies', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))

 # This class is part of an EXPERIMENTAL API.


class UpdateMovies(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Update(request,
               ...
               timeout=None,
               metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UpdateMovies/Update',
